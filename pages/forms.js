...
import { getPage, getForms } from "@/lib/sanity";
...
export default function Forms({ page, forms }) {
...
export async function getStaticProps() {
  const [page, forms] = await Promise.all([getPage("formsPage"), getForms()]);
